...
func NewIndexeWriter(path string) *IndexWriter {
	return &IndexWriter{indexDir: path}
}
...
// ポスティングリストをファイルに保存する
func (w *IndexWriter) postingsList(term string, postingsList PostingList) error {
